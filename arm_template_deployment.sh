...
az deployment group create \
  ...
  --template-file templates/PostgreSQLTemplate.json \
  --parameters parameters/PostgreSQLParameters.json \
...
az deployment group create \
  ...
  --resource-group Breakfast_Club_RG \
  --template-file templates/WebAppTemplate.json \
  --parameters parameters/WebAppParameters.json \